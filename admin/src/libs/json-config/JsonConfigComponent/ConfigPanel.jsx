...
class ConfigPanel extends ConfigGeneric {
	...
	/**
     ...
     Renders a list of configuration items based on the provided items object.
     @param {Object} items - The object containing the configuration items to render.
     @param {boolean} disabled - Determines if the items should be rendered as disabled.
     @returns {Array<React.Component>} Returns an array of React components representing the configuration items.
	 */
	render() {
...
const ConfigPanelStyled = ConfigPanel;
