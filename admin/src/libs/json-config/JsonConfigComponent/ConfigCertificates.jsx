			...
			<div className="">
				{this.state.collectionsOptions ? (
					<FormControl className="" variant="standard">
						...
						>
							<MenuItem key="_false" value="false" style={{ fontWeight: 'bold' }}>
								{I18n.t("ra_Do not use let's encrypt")}
							</MenuItem>
							<MenuItem key="_true" value="true" style={{ fontWeight: 'bold' }}>
				...
				<FormControl className="" variant="standard">
					...
					<Select
						...
						onChange={(e) =>
							this.onChange(this.props.schema.certPublicName || 'certPublic', e.target.value)
						}
					>
